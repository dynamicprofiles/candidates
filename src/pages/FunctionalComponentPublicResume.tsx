...
function FunctionalComponentPublicResume(props:any) {
    ...
    useEffect(() => {
        ...
        axios.get('public/profile/'+random_unique).then( (res)=> {
            setProfile(res.data)
    ...
    useEffect(() => {
        // Update the document title using the browser API
        axios.get('public/experiences/'+random_unique).then( (res)=> {
    ...
    useEffect(() => {
        // Update the document title using the browser API
        axios.get('public/educations/'+random_unique).then( (res)=> {
    ...
    const onButtonClick = () => {
        let domElement : HTMLElement | any = document.getElementById('my-node');
        htmlToImage.toPng(domElement,{quality: 100})
            .then(function (dataUrl) {
                console.log(dataUrl);
                const pdf = new jsPDF();
                pdf.addImage(dataUrl, 'PNG', 12, 15, 190, 190);
    ...
    return  (
        <div className="resume container-fluid" id="my-node">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2">
                            <div className="text-right">
                                <button data-toggle="tooltip" title="Send a Message"
                                        type="button" className="btn btn-danger tt blinker">Interested</button>
                    ...
                    <div className="row p-3">
                        {
                            profile.email_id ?
                                ...
                                <div className="col-md pb-2 pb-md-0">
                                    ...
                                    <a href="#" className="text-white ml-2">{profile.contact_number && profile.email_id}</a>
                                </div>
                            : null
...

                        {
                            profile.email_id ?
                                <div className="col-md text-md-center pb-2 pb-md-0">
                                    ...
                                    <a href="#" className="text-white ml-2">{profile.website && profile.website}</a>
                                </div>
                            : null
                        }
...
export default FunctionalComponentPublicResume;