...
const CompleteProfile = () => {
    ...
    let initialData = async (e: SyntheticEvent) => {
...
//                this.setState({experiences : [...(this.state.experiences ?? []),...res.data]})
    ...
    /*useLayoutEffect(()=>{
        (
            async ()=>{
                try {
                    const response = await axios.get('profiles/'+profile_id+'/experiences');
                    //ex = response.data
                    //setMyArray(oldArray => [...oldArray, newElement]);
                    setExperiences( (oldArray) => [oldArray,...response.data])
                    console.log(experiences)
                ...
                try {
                    const response = await axios.get('profiles/'+profile_id);
                ...
                try {
                    const response = await axios.get('profiles/'+profile_id+'/educations');
                    console.log(response.data)
                }catch (e) {
                }
            }
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-3 text-left text-md-center mb-3">
                            <img className="rounded-circle img-fluid" src="https://i.pravatar.cc/175?img=32"
                                 alt="Profile Photo"/>
                        </div>
                        ...
                        <div className="col-md-9">
                            ...
                            <p className="border-top pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                                odio lacus, sollicitudin in dolor at, consequat volutpat ante. Integer quis consequat
                                turpis, quis porta orci. Proin tincidunt volutpat faucibus. Suspendisse ac nisl purus
                                suspendisse eleifend interdum orci non pharetra. </p>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div className="container">
                    <div className="row p-3">
                        <div className="col-md pb-2 pb-md-0">
                            ...
                            <a href="#" className="text-white ml-2">lcollins@email.com</a>
                        </div>
                        <div className="col-md text-md-center pb-2 pb-md-0">
                            ...
                            <a href="#" className="text-white ml-2">www.lauracollins.com</a>
                        </div>
                        <div className="col-md text-md-right">
                            ...
                            <a href="#" className="text-white ml-2">+12 3456 7890</a>
                        </div>
                    </div>
                </div>
            </nav>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p>Mauris volutpat, ex condimentum fringilla imperdiet, nulla turpis semper diam, ac
                                    semper risus urna quis libero. Fusce non nunc quam. Ut vulputate, magna eget
                                    molestie luctus, elit est posuere lorem, quis dapibus dolor felis id mi.</p>
                            </li>
                            <li>
                                <h6 className="text-primary">Junior Web Developer / Websites 'R' Us 2004-2009</h6>
                                <p>Sed eu turpis placerat, posuere odio a, viverra velit. Pellentesque habitant morbi
                        ...
                        <ul>
                            <li>
                                ...
                                <p>Sed et ornare quam. Cras scelerisque ex ultricies neque sodales tristique. Phasellus
                                    mattis dui ut enim tincidunt auctor. Maecenas euismod, orci eget varius elementum,
                                    nunc massa dignissim sapien, ac sagittis libero dolor vitae elit.</p>
                            </li>
                            <li>
                                ...
                                <p>Aenean nisl enim, dictum in odio ut, suscipit efficitur diam. Nam nec velit a odio
                                    porta efficitur nec at magna.</p>
                            </li>
                        </ul>
                    </div>
                </div>
